...
!pip install pytorch-lightning gradio einops omegaconf torchmetrics webdataset accelerate tensorboard
!pip install PyMCubes trimesh rembg transformers diffusers bitsandbytes imageio[ffmpeg] xatlas plyfile
!pip install git+https://github.com/NVlabs/nvdiffrast jax jaxlib ninja
...
url = "https://atlas-content-cdn.pixelsquid.com/stock-images/standing-mirror-Nxrl0Q5-600.jpg"
response = requests.get(url)
input_image = Image.open(BytesIO(response.content))
processed_image = preprocess(input_image, True)
processed_image
mv_images, mv_show_images = generate_mvs(processed_image, 75, 42)
mv_images.save('/content/InstantMesh/mv_mirrors.png')
mv_show_images
...
mv_images = Image.open('/content/InstantMesh/mv_mirrors.png')
