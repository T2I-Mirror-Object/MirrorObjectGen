...
parser = argparse.ArgumentParser(description='Generate 2 images using FLUX.1-dev with ControlNet-Depth from 2 viewpoints with 2 separate prompts')
parser.add_argument(
    '--prompt-1',
    type=str,
    required=True,
    help='Text prompt for the first image (View 1)'
)
parser.add_argument(
    '--prompt-2',
    type=str,
    required=True,
    help='Text prompt for the second image (View 2)'
)
parser.add_argument(
    '--control-image-1',
    type=str,
...
parser.add_argument(
    '--output-dir',
    type=str,
    default="results/flux_controlnet_2views_2prompts",
...
print("=" * 60)
print("FLUX.1-ControlNet-Depth 2-Points-2-Prompts Generation")
print("=" * 60)
print(f"\nPrompt 1: {args.prompt_1}")
...
def generate_and_save(prompt, control_image_path, output_filename):
    # Load control image
    ...
    # Generate image
    print(f"Generating image for {output_filename} with prompt: '{prompt}'...")
...
# Generate for View 1
print("\n--- Processing View 1 ---")
success_1 = generate_and_save(args.prompt_1, args.control_image_1, "view1_generated.png")

# Generate for View 2
print("\n--- Processing View 2 ---")
success_2 = generate_and_save(args.prompt_2, args.control_image_2, "view2_generated.png")
