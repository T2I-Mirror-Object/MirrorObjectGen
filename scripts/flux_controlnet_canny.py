...
parser.add_argument(
    '--output',
    type=str,
    default="results/flux_controlnet_canny/output.png",
    help='Output image path (default: results/flux_controlnet_canny/output.png)'
)
parser.add_argument(
    '--height',
    type=int,
...
print("=" * 60)
print("FLUX.1-ControlNet-Canny Image Generation")
print("=" * 60)
print(f"\nPrompt: {args.prompt}")
