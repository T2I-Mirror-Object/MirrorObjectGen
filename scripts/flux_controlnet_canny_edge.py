...
parser = argparse.ArgumentParser(description='Generate images using FLUX.1-dev with ControlNet-Canny')
parser.add_argument(
    '--prompt',
    type=str,
    required=True,
...
parser.add_argument(
    '--control-image',
    type=str,
    default="results/edge/scene_edge_shap_e.png",
    help='Path to control image (edge map) (default: results/edge/scene_edge_shap_e.png)'
)
parser.add_argument(
    '--output',
    type=str,
    default="results/flux_controlnet/output_edge.png",
    help='Output image path (default: results/flux_controlnet/output_edge.png)'
)
parser.add_argument(
    '--height',
    type=int,
...
parser.add_argument(
    ...
    help='Path to ControlNet model (default: XLabs-AI/flux-controlnet-canny-v3)'
)
...
print("=" * 60)
print("FLUX.1-ControlNet-Canny Edge Image Generation")
print("=" * 60)
print(f"\nPrompt: {args.prompt}")
